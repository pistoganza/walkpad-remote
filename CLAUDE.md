...
- **Всегда инкрементировать версию** в шапке `index.html` (`<h1>WalkPad Remote <span ...>vN</span></h1>`) при любых изменениях функциональности или UI. Без исключений.

## Функциональность (v10)
